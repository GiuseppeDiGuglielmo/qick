...
# Create project
create_project ${_xil_proj_name_} ${origin_dir}/${_xil_proj_name_}${_xil_proj_name_suffix_} -part xczu49dr-ffvf1760-2-e
...
set files [list \
  [file normalize "${origin_dir}/${_xil_proj_name_}${_xil_proj_name_suffix_}/${_xil_proj_name_}.srcs/sources_1/bd/d_1/hdl/d_1_wrapper.v" ]\
]
add_files -fileset $obj $files
