...
# Debug readout1
set_property HDL_ATTRIBUTE.DEBUG true [get_bd_intf_nets {axis_readout_v2_1_m1_axis}]

# Debug trigger 0
set_property HDL_ATTRIBUTE.DEBUG true [get_bd_nets {vect2bits_16_0_dout8}]

# Debug trigger 1
set_property HDL_ATTRIBUTE.DEBUG true [get_bd_nets {vect2bits_16_0_dout9}]
...
apply_bd_automation -rule xilinx.com:bd_rule:debug -dict [list \
    ...
    [get_bd_intf_nets axis_readout_v2_1_m1_axis] {AXIS_SIGNALS "Data and Trigger" CLK_SRC "/usp_rf_data_converter_0/clk_adc2" SYSTEM_ILA "Auto" APC_EN "0" } \
]

# Connect triggers to ILA
set_property -dict [list CONFIG.C_NUM_OF_PROBES {2} CONFIG.C_MON_TYPE {MIX}] [get_bd_cells system_ila_0]
connect_bd_net [get_bd_pins system_ila_0/probe0] [get_bd_pins vect2bits_16_0/dout8]
connect_bd_net [get_bd_pins system_ila_0/probe1] [get_bd_pins vect2bits_16_0/dout9]
