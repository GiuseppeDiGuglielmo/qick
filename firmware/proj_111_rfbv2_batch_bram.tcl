...
# === BEGIN: NN ===============================================================
# Open block diagram
open_bd_design {${proj_dir}/top_111_rfbv2.srcs/sources_1/bd/d_1/d_1.bd}
...
connect_bd_net [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins clk_adc0_x2/clk_out1]
connect_bd_net [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins rst_adc0_x2/peripheral_aresetn]
...
apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config { Clk {/clk_adc0_x2/clk_out1 (512 MHz)} Freq {100} Ref_Clk0 {} Ref_Clk1 {} Ref_Clk2 {}}  [get_bd_pins NN_0/ap_clk]
